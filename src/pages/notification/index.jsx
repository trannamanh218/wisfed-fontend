...
import { handleListNotification } from 'reducers/redux-utils/notificaiton';
...
const NotificationModal = ({ setModalNotti, buttonModal }) => {
	...
	const { listNotifcaiton } = useSelector(state => state.notification);
